<%-- 
    Document   : addvehicle
    Created on : Dec 9, 2019, 12:36:11 AM
    Author     : Muhd Imran Syah Othman (B18CS0014)
--%>
...
<html>
    <head>
        ...
        <title>Add Vehicle Properties</title>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <h1 class="text-white">Add Vehicle</h1> 
          </div><!-- /.col -->
      ...
      <div class="container-fluid">
        <!-- Small boxes (Stat box) -->
            <form action="VehicleController" method="post"> 
                <input type="hidden" name="module" value="insertVehicle" />
	          	...
	          	<div class="col-lg-4 col-md-6 car-details-left">
                                <div class="row">
                                    ...
                                    <div class="card" style="width: 24rem; margin: 0 0 20px 20px">
                                        <img class="card-img-top" style="cursor: pointer;" src="http://localhost:8080/MotokarIP/admin-view/images/vehiclepicture.png" onclick="addImage()" />
                                        <div class="card-body" >
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Vehicle Name: <input class="form-control" type="text" name="vehicle_name" /></li>
                                                <li class="list-group-item">Doors: <input class="form-control" type="text" name="doors" /></li>
                                                <li class="list-group-item">Seats: <input class="form-control" type="text" name="seats" /></li>
                                                <li class="list-group-item">Transmission : <input class="form-control" type="text" name="transmission" /></li>
                                                <li class="list-group-item">Mileage: <input class="form-control" type="text" name="mileage" /></li>
                                            </ul>
                                            <br>
                                        </div>
                                    </div>
							  ...
							  <tbody>
							    <tr class="mytr">
							      	...
							      	<table class="table table-borderless table-rate">
									    <tbody>
									      <tr>
									        <th scope="row">Day</th>
									        <td width="10px">:</td>
									        <td>RM <input type="text" name="vehicleRateDay" /></td>
									      </tr>
									      <tr>
									        <th scope="row">Week</th>
									        <td width="10px">:</td>
									        <td>RM <input type="text" name="vehicleRateWeek" /></td>
									      </tr>
									      <tr>
									        <th scope="row">Month</th>
									        <td width="10px">:</td>
									        <td>RM <input type="text" name="vehicleRateMonth" /></td>
									      </tr>
									      <tr>
									        <th scope="row">Year</th>
									        <td width="10px">:</td>
									        <td>RM <input type="text" name="vehicleRateYear" /></td>
									      </tr>
									    </tbody>
									</table>
							      </td>
							      ...
							      <td ><b>Description:</b><br>
                                                                  <textarea type="text" name="vehicle_desc" class="form-control" rows="7" style="width: 100% !important;"></textarea>
                                                              </td>
							    </tr>
							  </tbody>
							</table>
